export const XP_PROFILE_BAR_TOOLTIPS: Record<string, string> = {
  xp_activity_display: "xPV/Jogo — valor de destino total gerado por 90 minutos.",
...
export const PASS_SCORE_TOOLTIPS: Record<string, string> = {
  ...
  "Chance creation":
    "Within-position composite of xPV per game from key passes, passes into the box, and impact passes originating in the final third.",
  Impact:
...
export const COMPONENT_TOOLTIPS: Record<string, string> = {
  ...
  key_xpv_p90: "xPV per game generated by key passes.",
  box_xpv_p90: "xPV per game generated by passes completed into the box.",
  ip_ft_xpv_p90: "xPV per game generated by impact passes originating in the final third.",
...
export const COMPONENT_LABELS: Record<string, string> = {
  ...
  key_xpv_p90: "Key passes xPV / game",
  box_xpv_p90: "Into box xPV / game",
  ip_ft_xpv_p90: "IP final third xPV / game",
